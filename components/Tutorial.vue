...
<template>
  <div
    class="relative flex items-top justify-center sm:items-center pt-16 pb-16"
  >
    <link
    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm:rounded-lg p-6">
        <prismic-rich-text
          ...
          :field="title"
        />
        <prismic-rich-text class="mt-3 text-gray-600" :field="description" />
    ...
    title: {
      ...
      default: () => {
        return [
          {
            type: "heading1",
            text: "Welcome to the Nuxt/Prismic Starter!",
            spans: [],
          },
        ];
      },
    ...
    description: {
      ...
      default: () => {
        return [
          {
            type: "paragraph",
            text: "This is a marketing website starter that utilities Prismic Slicemachine.",
            spans: [],
          },
        ];
      },
